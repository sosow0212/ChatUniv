...
include::{snippets}/chat-controller-unit-test/join_being_chatting_room/path-parameters.adoc[]
...
include::{snippets}/chat-controller-unit-test/use_mild_chat_bot/path-parameters.adoc[]
