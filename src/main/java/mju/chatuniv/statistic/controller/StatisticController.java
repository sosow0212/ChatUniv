...
import mju.chatuniv.statistic.controller.dto.MultiConversationResponse;
...
public class StatisticController {
    ...
    @GetMapping("/searches/{wordId}")
    public ResponseEntity<MultiConversationResponse> findWordContainingConversations(@PathVariable Long wordId) {
        MultiConversationResponse multiConversationResponse = MultiConversationResponse.from(statisticService.findWordContainingConversations(wordId));
        return ResponseEntity.ok(multiConversationResponse);
    }
}
